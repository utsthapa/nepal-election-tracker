...
// Canonical domain for all URLs (SEO, sitemap, robots, canonical links)
export const BASE_URL = 'https://nepalisoch.com';
...
export const BAYESIAN_CONFIG = {
  ...
  EXPECTATION_BASELINE: {
    ...
    JSPN: 0.05,
    US: 0.03,
    JP: 0.02, // Janamat Party (key 'JP' in PARTIES; Janadesh Party uses key 'Janadesh')
    LSP: 0.015,
    NUP: 0.01,
    Others: 0.005,
  },
