...
export const MAP_CONFIG = {
  ...
  center: [28.3949, 84.1240],       // Nepal geographic center
  zoom: 8,                          // More zoomed in
  minZoom: 8,                       // Lock zoom level (same as zoom)
  maxZoom: 8,                       // Lock zoom level (same as zoom)
  maxBounds: [[26.3, 80.0], [30.5, 88.5]],  // Nepal bounding box
