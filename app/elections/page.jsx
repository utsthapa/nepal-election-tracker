              ...
              return (
                ...
                >
                  <div className="flex gap-6">
                    ...
                    {/* Card */}
                    <div className="flex-1 bg-surface border border-neutral rounded-2xl p-6 group-hover:border-nc/50 transition-all">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                        <div>
                          ...
                          <h2 className="text-xl font-bold text-white group-hover:text-nc transition-colors">
                            {election.name}
                          </h2>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {/* Winner */}
                          <div className="bg-neutral/50 rounded-xl px-4 py-3 min-w-[120px]">
                          ...
                          {/* Total seats */}
                          <div className="bg-neutral/50 rounded-xl px-4 py-3 min-w-[100px]">
                            <div className="flex items-center gap-2 mb-1">
                              <Users className="w-4 h-4 text-gray-400" />
                              <span className="text-xs text-gray-400">Seats</span>
                            </div>
                            <p className="font-bold text-white">{election.totalSeats}</p>
                          </div>
                          ...
                          {election.turnout && (
                            <div className="bg-neutral/50 rounded-xl px-4 py-3 min-w-[100px]">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-xs text-gray-400">Turnout</span>
                              </div>
                              <p className="font-bold text-white">{election.turnout}</p>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="mt-4 pt-4 border-t border-neutral">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xs text-gray-500">Seat Distribution</span>
                        </div>
                            ...
                            .map(([party, seats]) => {
                              ...
                              return (
                                <div key={party} className="flex items-center gap-1 text-xs">
                                  ...
                                  />
                                  <span className="text-gray-400">{info.short}:</span>
                                  <span className="text-white font-mono">{seats}</span>
                                </div>
                              );
                            })}
                        </div>
