        ...
        {hasMajority ? (
          <>
            ...
            <div>
              <p className={`font-medium ${textColors[leadingParty]}`}>
                {formatPartyLabel(leadingParty)} has majority!
              </p>
          ...
          <>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                {formatPartyLabel(leadingParty)} leads with {leadingSeats} seats, needs {seatsToMajority} more
              </p>
            </div>
          </>
        )}
                ...
                <div className="flex items-center gap-2">
                  {coalition.parties.map((party, i) => (
                    <span key={party} className="flex items-center gap-1">
                      ...
                      <span className={`text-sm ${textColors[party]}`}>{formatPartyLabel(party)}</span>
                    </span>
                  ))}
                </div>
