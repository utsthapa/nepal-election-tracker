...
const PROVINCE_INFO = [
  { id: 1, name: 'Koshi', nameNp: 'कोशी', color: '#10b981', populationShare: 17 },
  { id: 2, name: 'Madhesh', nameNp: 'मधेश', color: '#f59e0b', populationShare: 21 },
  { id: 3, name: 'Bagmati', nameNp: 'बागमती', color: '#3b82f6', populationShare: 21 },
  { id: 4, name: 'Gandaki', nameNp: 'गण्डकी', color: '#8b5cf6', populationShare: 9 },
  { id: 5, name: 'Lumbini', nameNp: 'लुम्बिनी', color: '#ec4899', populationShare: 18 },
  { id: 6, name: 'Karnali', nameNp: 'कर्णाली', color: '#14b8a6', populationShare: 6 },
    ...
    <div className="space-y-3">
      {PROVINCE_INFO.map(province => (
        <ProvinceSection
          key={province.id}
          province={province}
          pattern={patterns?.[province.id]}
          turnoutRate={turnout?.[province.id]}
        ...
        <div className="text-left flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">
              {province.nameNp} • Turnout: {turnoutRate?.toFixed(1) || '65.0'}%
            </div>
          </div>
        </div>
