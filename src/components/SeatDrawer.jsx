                  ...
                  {partyOrder.map(party => (
                    <div key={party} className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-mono text-gray-400">
                        {(constituency.results2022[party] * 100).toFixed(1)}%
                      </span>
                    </div>
                  ))}
                </div>
                      ...
                      <div key={party}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className={`font-mono text-sm font-medium ${textColors[party]}`}>
                            {((localResults[party] || 0) * 100).toFixed(1)}%
                          </span>
                        </div>
                        <input
                          type="range"
                  ...
                  <div className="mt-4 pt-4 border-t border-neutral">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-mono text-white">
                        {(Object.values(localResults).reduce((a, b) => a + b, 0) * 100).toFixed(1)}%
                      </span>
                    </div>
                  </div>
                </motion.div>
                  ...
                  return (
                    <div>
                      ...
                      <p className="text-sm font-mono text-gray-400">
                        {(winner[1] * 100).toFixed(1)}% (+{(margin * 100).toFixed(1)}% margin)
                      </p>
                    </div>
                  );
                })()}
