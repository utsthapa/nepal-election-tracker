...
excerpt: "Nepal uses a century-old formula to turn millions of votes into 110 parliamentary seats. Here's how it actually works — and why it matters more than you think."
author: "Data Journalism Team"
date: "2026-02-17"
category: "Analysis"
tags: ["electoral-system", "proportional-representation", "sainte-lague", "methodology"]
...
Let's apply this to real data. In the 2022 election, here's how the PR votes broke down among parties that crossed the 3% threshold:
...
Look at those top two numbers. UML and NC were separated by fewer than 1,400 votes out of more than 9 million cast. That's a margin of 0.02 percentage points. And yet UML ended up with 34 PR seats to NC's 32 — a two-seat gap that looks a lot bigger than a 1,400-vote difference.
...
The average deviation between vote share and seat share? Just 1.51 percentage points. That's really good. For context, pure FPTP systems routinely produce deviations of 10-15 percentage points.

But "really good" isn't "perfect." UML got overrepresented by 4.3 points. JSPN got shortchanged by 1.27 points. These are rounding artifacts — inevitable when you're converting continuous percentages into discrete seats. The question isn't whether there's some distortion. There always will be. The question is whether the distortion is systematic or random.

With Sainte-Laguë, it's mostly random. And that matters.
...
In 2022, parties that fell below 3% collectively received about 283,450 votes — roughly 3% of the total. Those votes just... disappeared. They didn't count toward any seat allocation. The voters who cast them got FPTP representation in their local constituencies, but their PR votes were effectively wasted.
...
RSP's story is actually the best argument for why PR matters. The party didn't exist before 2022. It emerged as a genuine grassroots force, winning 13.05% of the PR vote. Under a pure FPTP system, a new party with geographically dispersed support would struggle to win individual constituencies. PR gave RSP a voice proportional to its actual support. Whether you like RSP's politics or not, that's democracy working as designed.
...
Here's what the data tells us clearly: Sainte-Laguë does what it's supposed to do. In 2022, the average deviation between vote share and seat share was 1.51 percentage points. That's about as good as you can get when converting percentages into whole numbers.
...
*All calculations use official Election Commission of Nepal data. For an interactive Sainte-Laguë calculator, visit our [tools page](/tools).*