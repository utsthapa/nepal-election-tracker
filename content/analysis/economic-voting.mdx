...
_Methodology: Panel regression analysis using Election Commission data from 1991-2022, Nepal Rastra Bank economic statistics, and World Bank development indicators. Constituency-level economic estimates are modeled from district and provincial data where direct measurements are unavailable. Full technical details available in our [economic voting analysis](/analysis/economic-voting)._
