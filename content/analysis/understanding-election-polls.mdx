...
<BarChart
  data={[
    { sampleSize: '400', marginOfError: 4.9 },
    { sampleSize: '600', marginOfError: 4.0 },
    { sampleSize: '1,000', marginOfError: 3.1 },
    { sampleSize: '1,500', marginOfError: 2.5 },
    { sampleSize: '2,500', marginOfError: 2.0 },
    { sampleSize: '4,000', marginOfError: 1.5 },
  ]}
  xKey="sampleSize"
  yKey="marginOfError"
  colors={['#B91C1C']}
...
_Figure: Sample size vs margin of error (95% confidence interval)_
...
<BarChart
  data={[
    { party: 'NC', pollAvg: 29, actual: 25.7, error: 3.3 },
    { party: 'UML', pollAvg: 26, actual: 27.0, error: -1.0 },
    { party: 'Maoist', pollAvg: 14, actual: 11.1, error: 2.9 },
    { party: 'RSP', pollAvg: 13, actual: 10.7, error: 2.3 },
    { party: 'Others', pollAvg: 18, actual: 25.5, error: -7.5 },
  ]}
  xKey="party"
  bars={[
    { key: 'pollAvg', name: 'Poll Average', color: '#94A3B8' },
    { key: 'actual', name: 'Actual Result', color: '#B91C1C' },
  ]}
  height={400}
/>

_Figure: 2022 polling accuracy — polls vs actual PR vote shares_
...
| NC | 29% | 25.7% | +3.3% |
| UML | 26% | 27.0% | -1.0% |
| Maoist Centre | 14% | 11.1% | +2.9% |
| RSP | 13% | 10.7% | +2.3% |
| Others | 18% | 25.5% | -7.5% |

**Average error**: ~3.4 percentage points

</Callout>

The polls got the broad picture right on direction: they identified a close NC-UML contest and correctly flagged RSP as a serious force in its first election. They also anticipated Maoist Centre's continued decline from 2017.

But they overstated support for the named parties (NC, Maoist, RSP) and badly underestimated the "Others" bucket — the fragmented collection of smaller parties (RPP, JSPN, JP, and others) that collectively grabbed about 25.5% of the PR vote. Polls put that bucket at 18%, undershooting by 7.5 points. That's the biggest systematic error, and it's not surprising: it's hard to poll for a dozen smaller parties individually, so their combined total gets underestimated. The average error across the five categories was about 3–4 percentage points — workable for calling the overall order of parties, but wide enough that close races between individual parties are hard to predict precisely.
...
Here's what we can say with confidence: polling in Nepal captured the 2022 election's main stories — RSP's emergence as a significant force, a tight NC-UML contest at the top, and continued Maoist decline. Where polls consistently fell short was in estimating the combined "Others" vote share, which was badly underestimated. Named-party polling was closer but still overestimated the big established parties somewhat. Average errors across the main categories ran around 3–4 percentage points.
