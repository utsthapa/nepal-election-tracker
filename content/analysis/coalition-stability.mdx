...
*Full methodology, source code, and historical coalition data are available in our [GitHub repository](https://github.com/nepalisoch). We'll be updating the Coalition Stability Index as new data becomes available and as the model is refined. Questions, critiques, and suggestions are welcome — this is a living project, and we'd rather be corrected than wrong.*